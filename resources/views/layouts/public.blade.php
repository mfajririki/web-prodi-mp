...
<head>
    ...
    <title>{{ $title }} | Manajemen Perusahaan Universitas Bina Darma</title>
                        ...
                        <div class="kingster-mm-menu-wrap kingster-navigation-font" id="kingster-mobile-menu" data-slide="right">
                            <ul id="menu-main-navigation" class="m-menu">
                                ...
                                <li class="menu-item menu-item-has-children"><a href="#">Kurikulum</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="{{ route('kurikulum_konten') }}">Kurikulum Manajemen Perusahaan</a></li>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                          ...
                          <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <li><a class="dropdown-item" href="{{ route('kurikulum_konten') }}">Kurikulum Manajemen Perusahaan</a></li>
                            ...
                            <div id="gdlr-core-custom-menu-widget-3" class="widget widget_gdlr-core-custom-menu-widget kingster-widget">
                                ...
                                <div class="menu-campus-life-container">
                                    <ul id="menu-campus-life" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-plain">
                                        ...
                                        <li class="menu-item"><a href="https://sisfo.binadarma.ac.id/" target="_blank">Manajemen Perusahaan Akademik</a></li>
